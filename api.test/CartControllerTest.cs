...
namespace api.test
{
    public class CartControllerTest
    {
        ...
        public void Setup()
        {
            ...
            //creación de objeto de controller con los mock
        ...
        public void ShouldReturnCharged()
        {
            ...
            //se configura el mock para que al ejecutar el método Charge retorne true
            //el helper It permite usar cualquier valor de un tipo de datos. En este caso se usa para pasar
            //cualquier valor double
            //se configura el mock para que al ejecutar el método Charge retorne true. El método recibe como
            //parámetro un double y una implementacion de ICard (cardMock.Object)
            paymentServiceMock.Setup(p => p.Charge(It.IsAny<double>(), cardMock.Object)).Returns(true);

            // ejecución de método para probar
        ...
        {
            //se configura el mock para que al ejecutar el método Charge retorne false
            //el helper It permite usar cualquier valor de un tipo de datos. En este caso se usa para pasar
            //cualquier valor double
            //se configura el mock para que al ejecutar el método Charge retorne true. El método recibe como
            //parámetro un double y una implementacion de ICard (cardMock.Object)
            ...
            // ejecucion del método a probar con los mock
            var result = controller.CheckOut(cardMock.Object, addressInfoMock.Object);
